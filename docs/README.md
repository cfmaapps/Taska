# CFMA TASKA GitHub Docs

This folder is here to answer one question clearly: what needs to be uploaded to GitHub?

Read these two files:

- [UPLOAD_TO_GITHUB.md](UPLOAD_TO_GITHUB.md) - exact files and folders to upload.
